...
const app = (() => {
  const translations = {
    'Pérez Paz | Reformas y muebles a medida': 'Pérez Paz | Renovations and custom furniture',
    'Ayuda | Pérez Paz': 'Help | Pérez Paz',
    'Contacto | Pérez Paz': 'Contact | Pérez Paz',
    'Política de privacidad | Pérez Paz Amoblamientos': 'Privacy Policy | Pérez Paz Amoblamientos',
    'Profesionales | Pérez Paz': 'Our team | Pérez Paz',
    'Proyectos | Pérez Paz': 'Inspiration | Pérez Paz',
    'Servicios | Pérez Paz': 'Services | Pérez Paz',
    'Términos y condiciones | Pérez Paz Amoblamientos': 'Terms and Conditions | Pérez Paz Amoblamientos',
    'Trabajá con nosotros | Pérez Paz': 'Work with us | Pérez Paz',
    'Configuración | Pérez Paz Amoblamientos': 'Settings | Pérez Paz Amoblamientos',
    'Lectura': 'Reading',
    ...
    'Pérez Paz Amoblamientos': 'Pérez Paz Furnishings',
    'PÉREZ PAZ AMOBLAMIENTOS': 'PÉREZ PAZ FURNISHINGS',
    'Reformas y muebles a medida': 'Renovations and custom furniture',
    'Logo de Pérez Paz': 'Pérez Paz logo',
    ...
    'En Pérez Paz Amoblamientos creemos que cada rincón de tu casa tiene un potencial único esperando ser descubierto. Nos especializamos en la reforma integral de ambientes y en el diseño y fabricación de muebles que combinan funcionalidad, estilo y durabilidad.': 'At Pérez Paz Furnishings, we believe every corner of your home has unique potential. We specialize in room renovations and custom furniture that combines function, style and durability.',
    ...
    'El responsable es el titular de Pérez Paz Amoblamientos. Deben completarse antes de publicar su nombre/razón social, domicilio legal y canal de contacto verificables. Para solicitudes de privacidad se muestra actualmente': 'The data controller is the owner of Pérez Paz Amoblamientos. Their verified legal name and address should be added before publication. For privacy requests, contact',
    ...
    'El formulario solicita nombre, correo electrónico, servicio de interés y mensaje para responder consultas, preparar presupuestos y dar seguimiento a la relación precontractual o contractual. El formulario está configurado para enviar la información a FormSubmit (servicio de terceros) y al correo indicado en su configuración. Antes de usarlo, el titular debe revisar las condiciones y medidas de privacidad de FormSubmit, sus destinatarios, ubicación/transferencias y retención, e informar cualquier cambio aquí. No envíes datos sensibles ni información de terceros que no sea necesaria.': 'The form asks for your name, email address, service of interest and message so we can respond, prepare quotes and follow up on a potential or existing business relationship. The form sends this information through FormSubmit, a third-party service, to the email address in its configuration. The site owner should review FormSubmit’s privacy terms, recipients, data location and retention practices and update this notice if they change. Do not send sensitive information or unnecessary information about others.',
    ...
    'El sitio se presenta bajo el nombre comercial Pérez Paz Amoblamientos. Antes de publicarlo, el titular debe completar y verificar su nombre o razón social, CUIT, domicilio legal y un canal de contacto efectivo. La información actualmente visible en Contacto debe comprobarse; los datos de ejemplo no identifican legalmente al proveedor.': 'This site operates under the trade name Pérez Paz Amoblamientos. Before publication, the owner must verify and provide their legal name, tax ID, registered address and an effective contact channel. The contact details shown on the Contact page must be checked; example details do not legally identify the provider.',
    ...
    '© 2026 Pérez Paz Amoblamientos. Diseño y reformas para tu hogar.': '© 2026 Pérez Paz Furnishings. Design and renovations for your home.',
    '© 2026 Pérez Paz Amoblamientos.': '© 2026 Pérez Paz Furnishings.',
